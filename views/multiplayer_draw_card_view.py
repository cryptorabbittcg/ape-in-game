...
class MultiplayerDrawCardView(View):
    """
    A Discord UI View for the Multiplayer 'Draw Card' action.
    ...
    def __init__(
        ...
        self.message = None  # Store the message object for timeout handling

    async def interaction_check(self, interaction: discord.Interaction) -> bool:
        """
        Ensures that only the current player can interact with the button.
        """
    ...
    @discord.ui.button(label="🃏 Draw Card", style=discord.ButtonStyle.primary, custom_id="multiplayer_draw_card_button")
    ...
    async def on_timeout(self):
        """
        Handles the timeout for the view. Disables the button and updates the message.
        """
    ...
    async def send_with_message(self, channel: discord.TextChannel, content: str):
        """
        Sends the view with a message and stores the message object for future edits.
        :param channel: The channel to send the message to.
        :param content: The content of the message.
        """
        self.message = await channel.send(content=content, view=self)